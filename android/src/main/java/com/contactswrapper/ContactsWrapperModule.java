...
@ReactModule(name = ContactsWrapperModule.NAME)
public class ContactsWrapperModule extends ReactContextBaseJavaModule implements ActivityEventListener {
  ...
  public static final String NAME = "ContactsWrapper";

  public ContactsWrapperModule(ReactApplicationContext reactContext) {
    super(reactContext);
